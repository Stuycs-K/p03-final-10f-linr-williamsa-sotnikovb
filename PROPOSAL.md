...
A description of your technical design. This should include: 
   ...
   We will be using semaphores/sockets/pipes(tentatively) to send data, networking, subservers, and signals to end the program and game.
...
Basic functionality of the game by Friday in class. Make everything run together by Wednesday and fix any bugs and stuff by the deadline. 
